...
class Post(models.Model):
    ...
    date_published = models.DateTimeField(auto_now_add=True, verbose_name="date published",null=True, blank=True)
    date_updated = models.DateTimeField(auto_now=True, verbose_name="date updated",null=True, blank=True)
...
def pre_save_post_post_receiever(sender, instance, *args, **kwargs):
	if not instance.slug:
		instance.slug = slugify(instance.author.username + "-" + instance.title)

pre_save.connect(pre_save_post_post_receiever, sender=Post)